...
| 409 | `TENANT_CLOSED` | Owning tenant is CLOSED (deployments with a governance plane); blocks reserve/commit/release/extend and takes precedence over reservation-state errors for non-replay requests |
